...
export const PROJECTS = [
  ...
  },
  {
    ...
    title: 'Antariksh',
    description:
      'Main Antariksh website built with high-contrast visuals, smooth motion sections, and performance-focused frontend interactions.',
  ...
  },
  {
    ...
    description:
      'Retrieval-Augmented Generation system using HuggingFace. Implements PDF parsing, vector embeddings, semantic search, and context-aware response generation with query memory.',
  ...
  },
  {
    ...
    description:
      'Data cleaning and exploratory data analysis on diabetes and e-commerce datasets. Applied linear regression, logistic regression, and one-hot encoding.',
